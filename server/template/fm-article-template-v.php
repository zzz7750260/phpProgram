			...
			<div class="row">
				<article class="theArticle col-md-9">
					...
					<div class="theArticle-FM"  data-article = <?php echo $value['fid']?>>
						<div class="FM-dmwall" id='FM-dmwall'>
							<div>
								<canvas id="canvas" style="border:0px solid #f00" width="100%" height="555">
								</canvas>					
							</div>
						</div>
						...
						<div>
							均衡器效果:<input type="button" value="效果1" id="fm-jh-1"><input type="button" value="效果2" id="fm-jh-2"><input type="button" value="效果3" id="fm-jh-3">
						</div>
						<div class="FM-zz" id='FM-zz'>
						...
						<audio id="audio" style=" " src="" crossOrigin="anonymous" controls="controls">
						</audio>
